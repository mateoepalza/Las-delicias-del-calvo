                        ...
                        <tbody id="tabla">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <select class='select-estado form-control' data-id='<?php echo $resultado->getIdCliente() ?>'>
...
<script type="text/javascript">
    $(function() {
        ...
        $('.table').on('change', '.select-estado', function() {
            ...
            $.post("indexAJAX.php?pid=<?php echo base64_encode("Vista/Security/Ajax/updateEstadoCliente.php") ?>", json, function(data) {
                res = JSON.parse(data);
