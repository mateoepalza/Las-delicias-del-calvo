...
if ($res == 1) {
    ...
    if ($_SESSION['rol'] == 1) {
         ...
         */
        $logAdmin = new LogAdmin("", $date->format('Y-m-d H:i:s'), LogHCrearIngredienteProducto($idProducto, $producto->getNombre(), $idIngrediente, $ingrediente->getNombre(), $cantidad), 3, getBrowser(), getOS(), $_SESSION['id']);
        /**
         ...
         * Creo el objeto de log
         */
        $logInventarista = new LogInventarista("", $date->format('Y-m-d H:i:s'), LogHCrearIngredienteProducto($idProducto, $producto->getNombre(), $idIngrediente, $ingrediente->getNombre(), $cantidad), 3, getBrowser(), getOS(), $_SESSION['id']);
        /**
         * Inserto el registro del log
         */
